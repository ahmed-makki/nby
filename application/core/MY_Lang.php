...
class MY_Lang extends CI_Lang {
  ...
  ***************************************************/
  ...
  // languages
  private $languages = array('ar' => 'arabic','en' => 'english');
  ...
  function MY_Lang()
  {
    ...
    { 
      ...
      $CFG->set_item('language', $this->languages['ar']);//$this->default_lang()
      ...
      $new_url = $CFG->config['base_url'].$index_url.'ar'.'/'.$uri;//$this->default_lang()
